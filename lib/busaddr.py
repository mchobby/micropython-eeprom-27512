""" EEPROM Programmer ADDRESS BUS controler.
    This implementation does not follows the initial sn75hc595 wiring,
	so code must be tweaked!

	Based on 74hc595, Shift Register - driver for MicroPython
	see https://github.com/mchobby/esp8266-upy/sn74hc595
